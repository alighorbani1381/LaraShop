...
@section('content')
	<section class="panel">
			<header class="panel-heading">
				<span class="main-tubmnail"> زباله دان دیدگاه ها </span>
			</header>
			...
			<tbody>
					...
					<tr>
						...
						<td class="btn-actions-controller">
							<a  href="{{  route ('comment.trash.create',$comment->id ) }}"><button class="btn btn-warning btn-xs"><i class="icon-user"></i></button></a>
						</td>
						<td class="btn-actions-controller">
